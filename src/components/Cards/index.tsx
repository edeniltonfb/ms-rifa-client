  ...
  return (
    <div className="w-full rounded-xl bg-gray-900 border border-gray-700 hover:border-blue-500 shadow-md p-4 transition-all duration-200 hover:shadow-lg">
      <div className="flex flex-col gap-1">
        <p className="text-2xl font-bold text-gray-400">{sorteio.dataSorteio}</p>
        <p className="text-lg font-semibold text-white truncate">{sorteio.titulo}</p>
        <p className="text-sm text-gray-300">{sorteio.subtipo}</p>
