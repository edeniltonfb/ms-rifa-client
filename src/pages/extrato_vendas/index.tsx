...
import ExtratoVendasCambistaPage from './extrato_cambista';
import ExtratoVendasAdminPage from './extrato_admin';
import ExtratoVendasRotaPage from './extrato_rota';
...
const ExtratoVendas = () => {
  ...
  return (
    <main className="min-h-screen pt-[100px] mx-auto bg-white rounded-2xl shadow-lg px-2">
      ...
      {profile === 'CAMBISTA' &&
        <ExtratoVendasCambistaPage />
      }
      {profile === 'SUPERVISOR' &&
        <ExtratoVendasRotaPage />
      }
      {profile === 'ADMIN' &&
        <ExtratoVendasAdminPage />
      }
    </main>
  );
}
